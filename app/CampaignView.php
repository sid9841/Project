...
class CampaignView extends Model
{
    ...
    public static function createViewLog($post) {
        ...
        if (CampaignView::where('session_id',\Request::getSession()->getId())->where('post_id',$post->id)->exists()){
            ...
            if(!array_search($arr_ip['country'], $countries)) $country= $arr_ip['country'];
            else  $country=array_search ($arr_ip['country'], $countries);
            $campaignViews->country=$country;
            $campaignViews->city=$arr_ip['city'];
            $campaignViews->agent = $browser;
            $campaignViews->save();
        }
